...
embedding_dim = 100
fasttext_model = FastText(sentences=train_sentences, vector_size=embedding_dim, window=5, min_count=1, workers=4, seed=42)
...
for word, idx in word_index.items():
    if word in fasttext_model.wv:
        ...
        # Random initialization for words not in FastText model
