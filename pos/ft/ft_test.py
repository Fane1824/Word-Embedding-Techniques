...
def prepare_fasttext_data(sentences):
...
def main():
    ...
    corpus_file = prepare_fasttext_data(train_sentences)
    
    # Train FastText model
    model_ft = fasttext.train_unsupervised(corpus_file, 
                                           model='skipgram',
                                           dim=100,
                                           epoch=10)
    ...
    # Include all tags from train and test
